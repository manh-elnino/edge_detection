...
public final class ScannerViewController: UIViewController {
    ...
    private lazy var autoScanButton: UIBarButtonItem = {
        let title = NSLocalizedString("wescan.scanning.manual", tableName: nil, bundle: Bundle(for: ScannerViewController.self), value: "マニュアル", comment: "The manual button state")
    ...
    @objc private func toggleAutoScan() {
        if CaptureSession.current.isAutoScanEnabled {
            ...
            autoScanButton.title = NSLocalizedString("wescan.scanning.manual", tableName: nil, bundle: Bundle(for: ScannerViewController.self), value: "マニュアル", comment: "The manual button state")
        } else {
